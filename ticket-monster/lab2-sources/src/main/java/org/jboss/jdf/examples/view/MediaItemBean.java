...
public class MediaItemBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      if (this.id == null)
      {
         this.mediaItem = this.example;
      }
      else
      {
         this.mediaItem = findById(getId());
      }
   }
   ...
   public MediaItem findById(Long id)
   {
      ...
      return this.entityManager.find(MediaItem.class, id);
   }
   ...
   private MediaItem example = new MediaItem();
   ...
   public MediaItem getExample()
   {
      return this.example;
   }

   public void setExample(MediaItem example)
   {
   ...
   private Predicate[] getSearchPredicates(Root<MediaItem> root)
   {
      ...
      MediaType mediaType = this.example.getMediaType();
      if (mediaType != null)
      {
   ...
   public Converter getConverter()
   {
      ...
      final MediaItemBean ejbProxy = this.sessionContext.getBusinessObject(MediaItemBean.class);
