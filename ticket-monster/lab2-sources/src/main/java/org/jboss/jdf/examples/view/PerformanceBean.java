...
public class PerformanceBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      if (this.id == null)
      {
         this.performance = this.example;
      }
      else
      {
         this.performance = findById(getId());
      }
   }
   ...
   public Performance findById(Long id)
   {
      ...
      return this.entityManager.find(Performance.class, id);
   }
   ...
   private Performance example = new Performance();
   ...
   public Performance getExample()
   {
      return this.example;
   }

   public void setExample(Performance example)
   {
   ...
   public Converter getConverter()
   {
      ...
      final PerformanceBean ejbProxy = this.sessionContext.getBusinessObject(PerformanceBean.class);
